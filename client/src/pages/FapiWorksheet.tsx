    ...
    return (
      <div className="flex flex-col items-center justify-center h-full text-center px-6">
        <div
          ...
          style={{ background: `linear-gradient(135deg, ${PURPLE}20, ${ORANGE}20)` }}
        >
      ...
      <div className="flex flex-col h-full">
        <div className="px-4 py-3 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-600 text-gray-800">AI Assistant — Sophia</span>
          </div>
        </div>
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          <div className="bg-purple-50 rounded-lg p-3 border border-purple-100">
            <p className="text-xs text-gray-700 leading-relaxed">
              <span className="font-600" style={{ color: PURPLE }}>Sophia:</span> I've reviewed the FAPI worksheet for SAS paris. All sections are currently at zero — you'll need to enter the annual average FX rate and property income figures to begin the calculation.
            </p>
          </div>
          <div className="bg-amber-50 rounded-lg p-3 border border-amber-100">
            <p className="text-xs text-gray-700 leading-relaxed">
              <span className="font-600 text-amber-700">Suggestion:</span> For the FX rate, the Bank of Canada annual average EUR/CAD rate for 2025 is approximately 1.4821. Would you like me to populate this?
            </p>
          </div>
          <div className="bg-blue-50 rounded-lg p-3 border border-blue-100">
            <p className="text-xs text-gray-700 leading-relaxed">
              <span className="font-600 text-blue-700">Note:</span> Under ss.95(1) ITA, SAS paris qualifies as a controlled foreign affiliate. Property income from dividends received from non-resident corporations will be included in FAPI under Component A.
            </p>
          </div>
        </div>
